...
def chi(ordered):
    ...
    sum = 0
    for i in ordered:
      sum += math.pow((expected + i), 2) / expected
    return sum
...
def main():
  ...
  if sys.argv[1] == '-b':
    ...
    text1 = readbinaryfile(fn)
    text2 = readbinaryfile(f2n)
  
  ordered1 = norm(orderedCount(text1, alphabet))
  ordered2 = norm(orderedCount(text2, alphabet))
  #normBar(alphabet, ordered, title=fn, imagename=fn+".png")
  print("The Bhattacharyya Distance for these files is: " + bdist(ordered1, ordered2))
  print("The chi square of file 1 is: " + chi(ordered1))
  print("The chi square of file 2 is: " + chi(ordered2))
